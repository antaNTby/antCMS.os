...
class DWord
{
    ...
    public function GetHTML_Representation()
    {
        $res = '';
        $res .= '<table>';
    ...
    public function ShiftToLeft($countBit)
    {
    ...
    public function ShiftToRight($countBit)
    {
        $resBitArray = $this->bitArray;
    ...
    public function BitwiseOR($dwordObject)
    {
        $res = new self();
        for ($i = 0; $i <= 31; $i++)
        {
    ...
    public function BitwiseAND($dwordObject)
    {
        $res = new self();
        for ($i = 0; $i <= 31; $i++)
        {
    ...
    public function BitwiseXOR($dwordObject)
    {
        $res = new self();
        for ($i = 0; $i <= 31; $i++)
        {
    ...
    public function Plus($dwordObject)
    {
        $res = new self();
        $cf  = 0;
        for ($i = 0; $i <= 3; $i++)
